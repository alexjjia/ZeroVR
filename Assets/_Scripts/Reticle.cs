...
public class Reticle : MonoBehaviour {
	...
	public GameObject leftPlayerCannon;
	public GameObject rightPlayerCannon;
	...
	void Start () {
		...
		showHUD = false;
		showDistance ();
		leftPlayerCannon = GameObject.Find ("Left Cannon");
		rightPlayerCannon = GameObject.Find ("Right Cannon");
	...
	void Update () {
		...
		leftPlayerCannon.transform.LookAt (canvas.transform);
		rightPlayerCannon.transform.LookAt (canvas.transform);
	}
	void showDistance()
	{
